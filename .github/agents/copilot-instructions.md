...
- 003-antd-cms-frontend: Added TypeScript 5.9.3 with React 19.2.0 + Ant Design 5.12.0, Zustand 4.4.7, Axios 1.6.2, React Router DOM 6.20.1, Zod 3.22.4
- 002-soft-delete-implementation: Added TypeScript with Node.js 18+ + Express.js, Sequelize ORM 6.x, MySQL 8.0+
